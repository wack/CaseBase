...
class ReferencesControllerTest < ActionController::TestCase
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post :create, reference: { description: @reference.description, email: @reference.email, firstN: @reference.firstN, lastN: @reference.lastN, phone: @reference.phone }
    end
  ...
  test "should update reference" do
    put :update, id: @reference, reference: { description: @reference.description, email: @reference.email, firstN: @reference.firstN, lastN: @reference.lastN, phone: @reference.phone }
    assert_redirected_to reference_path(assigns(:reference))
  end
